...
public class tableau_ia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tableau_ia);
                            ...
                            if (intent != null && intent.hasExtra("KEY_SUBJECT")) {
                                ...
                                databaseReference.push().setValue(absence).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        {
                                            Toast.makeText(tableau_ia.this,"Absence saved",Toast.LENGTH_LONG).show();
                                        }
                                    }
                                });
                            }
