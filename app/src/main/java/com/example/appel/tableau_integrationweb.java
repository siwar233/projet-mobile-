...
public class tableau_integrationweb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tableau_integrationweb);
                            ...
                            if (intent != null && intent.hasExtra("KEY_SUBJECT")) {
                                ...
                                databaseReference.push().setValue(absence).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        {
                                            Toast.makeText(tableau_integrationweb.this,"Absence saved",Toast.LENGTH_LONG).show();
                                        }
                                    }
                                });
                            }
